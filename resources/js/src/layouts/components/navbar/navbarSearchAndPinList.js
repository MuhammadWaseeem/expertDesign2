...
export default {
  pages: {
    ...
    data: [
      // DASHBOARDS
      {title: "Admin Dashboard",            url: "/dashboard/admin",                    icon: "HomeIcon",                  is_bookmarked: true},
      // Risk Assessment
      {title: "Add Risk Assessment",        url: "/risk-assessment",                    icon: "CheckCircleIcon",           is_bookmarked: true},
      {title: "History Risk Assessment",    url: "/risk-assessment/history",            icon: "CheckCircleIcon",           is_bookmarked: false},

      // User
      {title: "User List",                  url: "/all-users",                          icon: "ListIcon",                   is_bookmarked: false},
      // User
      {title: "Add Gas Safety Record",      url: "/gas-safety",                         icon: "ArchiveIcon",                is_bookmarked: false},
