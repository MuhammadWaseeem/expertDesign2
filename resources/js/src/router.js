      ...
      children: [
        ...
        },
        {
...

          {
              ...
              component: () => import('./site/LDRA.vue'),
              meta: {
                  breadcrumb: [
                      { title: 'Home', url: '/' },
                      { title: 'Legionnaires Disease risk assessment & guidelines', active: true }
                  ],
                  rule: 'user',
                  authRequired: true
              }
          ...
          {
              path: '/risk-assessment/edit/:id',
              name: 'risk-assessment',
              component: () => import('./site/LDRA.vue'),
              meta: {
                  breadcrumb: [
                      { title: 'Home', url: '/' },
                      { title: 'Legionnaires Disease risk assessment & guidelines',url:'/risk-assessment'},
          ...
          {
              path: '/risk-assessment/history',
              name: 'assessment-history',
              component: () => import('./site/LDRATable.vue'),
              meta: {
                  breadcrumb: [
                      { title: 'Home', url: '/' },
                      { title: 'Legionnaires Disease risk assessment & guidelines',url: '/risk-assessment'  },
...

          {
              path: '/all-users',
              name: 'AllUsers',
              component: () => import('./site/User/UserList'),
              meta: {
                  breadcrumb: [
                      { title: 'Home', url: '/' },
        ...
        // =============================================================================

          {
              path: '/gas-safety',
              name: 'gas-safety',
              component: () => import('./site/GasSafety/AddRecord'),
              meta: {
                  breadcrumb: [
                      { title: 'Home', url: '/' },
                      { title: 'LANDLORD/HOME OWNER GAS SAFETY RECORD', active: true }
                  ],
                  rule: 'superAdmin',
                  authRequired: true
              }
          },
          {
              path: '/location-flue',
              name: 'location-flue',
              component: () => import('./site/Data/Location&Flue'),
              meta: {
                  breadcrumb: [
                      { title: 'Home', url: '/' },
                      { title: 'Location & Flue Type', active: true }
                  ],
                  rule: 'admin',
                  authRequired: true
              }
      ...
      children: [
        ...
        // =============================================================================
...

          {
              ...
              component: () => import('@/site/LDRADetail.vue'),
              meta: {
                  rule: 'user'
              }
          },
...
router.beforeEach((to, from, next) => {
    let isAuthenticated = localStorage.getItem('userInfo') && localStorage.getItem('accessToken');
